...
namespace FlowersStore
{
    public class EmailService : IIdentityMessageService
    {
        ...
        {
            var apiKey = Environment.GetEnvironmentVariable("Yuliya");
            var client = new SendGridClient(apiKey);
            var from = new EmailAddress("elinaazaliya@gmail.com", "Yuliya");
            var subject = message.Subject;
            var to1 = new EmailAddress(message.Destination);
    ...
    public class ApplicationDbInitializer : DropCreateDatabaseIfModelChanges<ApplicationDbContext>
    {
        ...
        public static void InitializeIdentityForEF(ApplicationDbContext db)
        {
            ...
            const string name = "yuliya131017@gmail.com";
